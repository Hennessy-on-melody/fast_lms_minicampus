...
public class MemberController {
    ...
    public String login(HttpServletRequest request) {
        ...
        String ip = ipAddFiltering(request.getHeader("X-Forwarded"), request);

        return "member/login";
    }

    private String ipAddFiltering(String userIp, HttpServletRequest request) {
        if (userIp == null){
        ...
        if (userIp == null){
            userIp = request.getHeader("HTTP_GET_CLIENT_IP");
        }
        if (userIp == null){
